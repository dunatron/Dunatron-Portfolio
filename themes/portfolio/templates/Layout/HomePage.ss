    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="pull-left img-responsive hidden" href="#" id="brandShrink">
                ...
                <p class="whiteText">Portfolio Heath Dunlop
...
<div id="content">
    ...
    <section class="bg-1">
        <div class="col-sm-6 col-sm-offset-3 text-center">
            <h2 style="padding:20px;background-color:rgba(5,5,5,.8); color: #f58026">Mobile First + Responsive Web
                Design</h2>

            <p style="padding:20px;background-color:rgba(5,5,5,.8);">
                <strong style="color: #f58026">RWD what is it?</strong>
                <br>
                RWD(Responsive Web Design) is an approach to web design, designed at optimizing the viewing experience
                through media queries. These media queries change the way the content is rendered based upon the devices
                dimensions.
                <br>
                <br>
                ...
                This means that if your site is not optimized for mobile viewing then your customers are clicking away
                to the competition. Another reason is SEO(Search Engine Optimization). A site that is responsive will be
                bumped up quite substantially in the google rankings. To be blunt google favours sites that are
                responsive and is encouraging RWD to become the standard<br>
                <br>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <h2>About</h2>
            <hr>
            <h4 style="text-align: left;">This Section contains the latest tutorials that I have released. These
                tutorials are focused on silverstripe, my
                framework of choice. But will also include some css Tutorials for some beautiful css tricks. To view all
                tutorials click the
                Tutorials tab in the menu. To get the source code or other repo's visit <a
                        href="https://github.com/dunatron/">my git page</a></h4>
        </div>
    ...
    <section class="bg-3" id="sectionAbout">
        ...
        <div class="col-sm-6 col-sm-offset-3 text-center"><p style="padding:20px;background-color:rgba(5,5,5,.8)"
                                                             class="whiteText">
            While studying a Bachelors’ Degree in Information Technology at the Southern Institute of Technology, I was
            able
            ...
            I feel the ability to manipulate, and control technology is stimulating and rewarding. My greatest
            satisfaction
            ...
            fulfilment and the satisfaction of being involved in the design process. I want to be involved in a team
            that
